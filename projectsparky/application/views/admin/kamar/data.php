                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><button class="btn btn-warning " data-toggle="modal"
                                        data-target="#contact-modal">Add Room</button></strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result as $kmr) {
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?= base_url('images/kamar/' . $kmr->gambar) ?>" width="150px"
                                                        height="100px"></td>
                                                <td>
                                                    <?= $kmr->jenis ?>
                                                </td>
                                                ...
                                                <?php if ($tampil == true) {
                                                    $tampil = $kmr->amount - $tampil->amount;
                                                } else {
                                                    $tampil = $kmr->amount;
                                                } ?>
                                                <td>
                                                ...
                                                <td>
                                                    <a class="btn btn-success"
                                                        href="<?= site_url('Room/edit/' . $kmr->id) ?>">Edit</a>
                                                    <a class="btn btn-danger"
                                                        href="<?= site_url('Room/delete/' . $kmr->id) ?>"
    ...
    <div id="contact-modal" class="modal fade" role="dialog" style="margin-top: 200px">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?= site_url('Room/do_upload') ?>" method="post" enctype="multipart/form-data"
                    ...
                    <div id="pay-invoice">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="cc-exp" class="control-label mb-1">Available</label>
                                        <input id="cc-exp" name="amount" type="tel" class="form-control ">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <label for="x_card_code" class="control-label mb-1">Room Picture</label>
