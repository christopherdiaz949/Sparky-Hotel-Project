            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <ul class="nav navbar-nav">
                        ...
                        <h3 class="menu-title">Control</h3><!-- /.menu-title -->
                    ...
                    <div class="dropdown float-right">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                            <div class="dropdown-menu-content">
                                <a class="dropdown-item" href="<?= site_url('User/read') ?>">Manage</a>
                            </div>
                        </div>
                    </div>
                    <h4 class="mb-0">
                        <span class="count">
                            <?= $this->db->count_all('user_data'); ?>
                        </span>
                    </h4>
            ...
            <div class="card text-white bg-flat-color-2">
                <div class="card-body pb-0">
                    <div class="dropdown float-right">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                            <div class="dropdown-menu-content">
                                <a class="dropdown-item" href="<?= site_url('Room/read') ?>">Manage</a>
                            </div>
                        </div>
                    </div>
                    <h4 class="mb-0">
                        <span class="count">
                            <?= $this->db->count_all('kamar'); ?>
                        </span>
                    </h4>
                    <p class="text-light">Room & Suites</p>
            ...
            <div class="card text-white bg-flat-color-5">
                <div class="card-body pb-0">
                    <div class="dropdown float-right">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                            <div class="dropdown-menu-content">
                                <a class="dropdown-item" href="<?= site_url('Transaction/read') ?>">Manage</a>
                            </div>
                        </div>
                    </div>
                    <h4 class="mb-0">
                    ...
                    <p class="text-light">Transaction Completed</p>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-flat-color-4">
                <div class="card-body pb-0">
                    ...
                    <p class="text-light">Pending Transaction</p>
