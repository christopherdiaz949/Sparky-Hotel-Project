            ...
            <div class="header-menu">
                ...
                <div class="col-sm-5">
                    ...
                    <div class="language-select dropdown" id="language-select">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="language" aria-haspopup="true"
                            aria-expanded="true">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><button class="btn btn-warning " data-toggle="modal"
                                        data-target="#contact-modal">Add User</button></strong>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?= base_url('images/user/' . $user->picture) ?>" width="35px"
                                                    height="40px" style="border-radius: 100%">
                                            </td>
                                            <td>
                                                <?= $user->name ?>
                                            </td>
                                            ...
                                            <td>
                                                <a class="btn btn-success"
                                                    href="<?= site_url('User/edit/' . $user->user_id) ?>">Edit</a>
                                                <a class="btn btn-danger"
                                                    href="<?= site_url('User/delete/' . $user->user_id) ?>"
                    ...
                    <div id="pay-invoice">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-number" name="email" type="text" class="form-control">
                            </div>
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="cc-exp" class="control-label mb-1">Telp. Number</label>
                                        <input id="cc-exp" name="no" type="text" class="form-control ">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="cc-j" class="control-label mb-1">Role</label>
                                ...
                                <div class="col-4">
                                    <label for="x_card_code" class="control-label mb-1">Profile Picture</label>
