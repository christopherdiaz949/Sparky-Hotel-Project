                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="<?= site_url('User/read') ?>">Back</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Change User Data:<br>
                                                <?= $detail->name ?>
                                            </h3>
                                        </div>
                                        <hr>
                                        <form action="<?= site_url('User/update/' . $detail->user_id) ?>" method="post"
                                            novalidate="novalidate" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <img src="<?= base_url('images/user/' . $detail->picture) ?>"
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="cc-name" value="<?= $detail->name ?>" name="nama" type="text"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-number" name="email" type="tel" class="form-control"
                                                    value="<?= $detail->email ?>" maxlength="100" required>
                                            </div>
                                            <div class="row">
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-exp" name="no" type="tel" class="form-control"
                                                            value="<?= $detail->telp_num ?>" pattern=”[0-9]+”
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="cc-exp" name="akses" class="form-control" required>
                                                            <option>Admin</option>
                                                            <option>User</option>
                                                        </select>
                                                    </div>
