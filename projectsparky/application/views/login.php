...
.login-reg-panel {
    ...
    margin: auto;
    height: 400px;
    background-color: rgba(58, 196, 250, 0.9);
}
...
<body>
    <div class="login-reg-panel">
        <div class="login-info-box">
            <h2><b>Welcome to Sparky Hotel!</b></h2>
            <p>Let's begin our journey, shall we?</p>
            <label id="label-register" for="log-reg-show">Login</label>
            <input type="radio" name="active-log-panel" id="log-reg-show" checked="checked">
        </div>

        <div class="register-info-box">
            <h2><b>Don't have an Account? Create One!</b></h2>
            <p>And join us on the journey! <b>#LiveThere</b></p>
